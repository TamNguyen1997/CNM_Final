  ...
  <div id="accounts" class="text-center">
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        ...
        <AccountBox v-for="a in listAccount" :key="a.number" :number="a.number" :balance="a.balance" :option="optClicked" v-on:delID="handlerDelClick"></AccountBox>
  
        <button class="btn btn-default edit-btn" @click="handleOption">
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button v-if="listAccount.length > 2 && accSelected.balance === 0" type="button" class="btn btn-danger" data-dismiss="modal" @click="handleDelAcc">OK</button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleDelAcc() {
        const self = this;
        self.closingUserAccount(self.accSelected.number)
          .then(data => {
            if (data && data.success) {
