      ...
      <div class="panel-body">
        ...
        <form class="form-horizontal text-right">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <select id="selectUser" class="form-control" @change="listUserClicked(selectedUser)" v-model="selectedUser">
                  <option
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <select id="selectAcc" class="form-control" @change="listAccountClicked(selectedAccount)" v-model="selectedAccount">
                  <option
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="plaintext" id="txtEmail" :value="selectedUser.email" placeholder="Account owner email" readonly>
            </div>
          </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      listAccountClicked(selectedAccount) {
        const self = this;
        self.selectedAccount == self.selectedAccount.id
      },
      listUserClicked(username) {
        const self = this;
  
        if (self.selectedUser !== "Choose username") {
          self.getUserAccounts(self.selectedUser.id).then(data => {
            if (data && data.success) {
