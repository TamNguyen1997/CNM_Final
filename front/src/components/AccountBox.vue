    ...
    <div class="panel panel-success text-left">
        <div class="panel-heading">
            <h3 class="panel-title">
                ...
                <button v-show="option" class="btn-danger d-right round-button del-btn" data-toggle="modal" data-target="#myModel" @click="handlerDelBtn" id="delbtn">
        ...
        <div class="panel-body">
            ...
            <span id="money" class="label label-warning text-right d-right money">
                    <!-- {{balance.toLocaleString()}} <span class="badge">VNĐ</span> --> {{ balance }} <span class="badge">VNĐ</span>
            </span>
