    ...
    <div class="panel panel-success text-left">
        <div class="panel-heading">
            <h3 class="panel-title">
                <span class="glyphicon glyphicon-time"></span> &emsp;
                <span>{{getDate}}</span>
        ...
        <div class="panel-body">
            <b class="acc-number" v-bind:class="{ 'text-info': selectedNumber === numberSrc }"># No. {{numberSrc}}</b>&emsp;
            <span class="glyphicon glyphicon-share-alt"></span>&emsp;
            <b class="acc-number" v-bind:class="{ 'text-info': selectedNumber === numberDes }"># No. {{numberDes}}</b>
    
            <span id="money" class="label label-warning text-right d-right money">
                {{total}} <span class="badge">VNĐ</span>
            </span>
