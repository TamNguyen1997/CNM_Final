      ...
      <div class="panel-body">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-success" @click="handleTransfer">Submit</button>
        ...
        <form class="form-horizontal text-right">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" v-model="description" class="form-control" id="txtDescription" placeholder="note">
            </div>
          </div>
  
          <div class="form-group text-center">
            <input type="radio" id="one" value="true" v-model="feeCharger" checked>&ensp;
            <label for="one">Your charge fee</label> &ensp;
            <input type="radio" id="two" value="false" v-model="feeCharger">&ensp;
            <label for="two">Receiver charge fee</label>
          </div>
  
          <div class="glyphicon glyphicon-share-alt text-center" style="display: block; font-size: 30px; margin-bottom: 15px;"></div>
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="string" v-model="inputAccount" class="form-control" id="receiver" required placeholder="input account number">
          ...
          <div class="form-group col-sm-6">
            ...
            <div class="col-sm-8">
              <input type="text" class="plaintext" id="txtName" :value="accountInfo.owner" placeholder="Account name" readonly>
            </div>
          </div>
          ...
          <div class="form-group  col-sm-6">
            ...
            <div class="col-sm-8">
              <input type="text" class="plaintext" id="txtEmail" :value="accountInfo.email" placeholder="Account email" readonly>
            </div>
          </div>
          ...
          <div class="form-group  col-sm-6">
            ...
            <div class="col-sm-8">
              <input type="text" class="plaintext" id="txtPhone" :value="accountInfo.phone" placeholder="Account phone" readonly>
            </div>
          </div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      const self = this;
      self.getUserAccounts(self.account.user.id).then(data => {
    ...
    methods: {
      ...
      handleSubmit() {
        ...
        self.createTransaction({
          ...
          .then(data => {
            if (data && data.success) {
              self.transactionId = data.trans.id;
              $('#myModel').modal('show');
            }
          })
      }
